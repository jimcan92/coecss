...
<div class="grid h-full max-h-svh w-full md:grid-cols-[14rem_1fr]">
	<div class="bg-muted/40 hidden border-r md:block">
		<div class="flex h-full max-h-svh flex-col gap-2">
			<Nav />
		</div>
	</div>
	<div class="flex h-full max-h-svh flex-col">
		...
		<main class="flex h-[calc(100%-3.5rem)] w-full flex-col">
			{@render children()}
		</main>
	</div>
</div>
